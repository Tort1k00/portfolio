...
const HomePage = () => {
    return (
        <div className="py-5 mt-4 d-flex flex-column align-items-center text-center">
           ...
           <hr className="opacity-25 my-5 col-md-8 col-8" /> 

          <h2 className="fs-4 fw-light mb-4 px-5">
            Full Stack & Mobile App Developer • JavaScript & React
          </h2>

          <div className="lead col-md-8 px-5">
